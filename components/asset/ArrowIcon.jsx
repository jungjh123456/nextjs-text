...
const ArrowIcon = (props) => {
  return (
    <svg data-name={props.dataname} data-status={props?.dataStatus} data-id={props?.id} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
